...
All message initial and final bodies are logged to a database table via
"RoutePolicy." 
As distributed, the database is a SQLite3
file located in the root folder of the main branch as mydata.db, which 
...
On the "jpa" branch, this is replaced with database file route_messages.db,
